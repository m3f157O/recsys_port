...
class YeldReader(object):
    URM_DICT = {}
    ICM_DICT = {}

    def __init__(self, pre_splitted_path):

        super(YeldReader, self).__init__()
        ...
        try:
            ...
            print("YeldReader: Attempting to load pre-splitted data")
            ...
            print("YeldReader: Pre-splitted data not found, building new one")

            print("YeldReader: loading URM")
